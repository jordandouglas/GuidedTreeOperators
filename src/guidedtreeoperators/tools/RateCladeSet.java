 ...
 */
//TODO not tested
public class RateCladeSet extends FrequencySet<BitSet> {
    //
    // Public stuff
    //
     ...
     */
    public RateCladeSet(Tree tree, TaxonSet taxonSet) {
...
//    }
    ...
    public Node getClade(int index, Tree tree) {
        BitSet bits = get(index);
